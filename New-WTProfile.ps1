...
[Parameter(ValueFromPipelineByPropertyName)]
[ComponentModel.DefaultBindingProperty('experimental.autoMarkPrompts')]
[switch]
$AutoMarkPrompts,
...
[Parameter(ValueFromPipelineByPropertyName)]
[ComponentModel.DefaultBindingProperty('experimental.showMarksOnScrollbar')]
[switch]
...
[Parameter(ValueFromPipelineByPropertyName)]
[ComponentModel.DefaultBindingProperty('useAtlasEngine')]
[switch]
$UseAtlasEngine,
...
[ValidateSet('never','indexed','always')]
[string]
